...
- `CLIENT_ID`: The twitch client id for your application, which has the `user:read:chat`, `user:bot` and `channel:bot` scopes for the channels you're trying to join.
